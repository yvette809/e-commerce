...
export const listProducts = (keyword = '', pageNumber = '') => async (
    ...
    try {
      ...
      const { data } = await axios.get(
        `http://localhost:4060/api/products?keyword=${keyword}&pageNumber=${pageNumber}`
      )
...
export const deleteProduct = (id) => async (dispatch, getState) => {
  ...
  export const createProduct = () => async (dispatch, getState) => {
    try {
      ...
      const { data } = await axios.post(`http://localhost:4060/api/products`, {}, config)
  ...
  export const createProductReview = (productId, review) => async (
    ...
    try {
      ...
      await axios.post(`http://localhost:4060/api/products/${productId}/reviews`, review, config)
